...
#define SPIRE_ERROR_INVALID_PARAMETER -2
    ...
    */
    ...
    enum
    {
        ...
        SPIRE_PARAMETER_CATEGORY_DESCRIPTOR_TABLE_SLOT,
        SPIRE_PARAMETER_CATEGORY_SPECIALIZTION_CONSTANT,
...
#define SPIRE_SAFE_BOOL(expr) \
    ...
    enum ParameterCategory : SpireParameterCategory
    {
        ...
        DescriptorTableSlot = SPIRE_PARAMETER_CATEGORY_DESCRIPTOR_TABLE_SLOT,
        SpecializationConstant = SPIRE_PARAMETER_CATEGORY_SPECIALIZTION_CONSTANT,
